...
function propertyEditorDbQuery(string $sql)
{
...
function propertyEditorDbFetchArray(&$result)
{
...
if (isset($_POST['Submit'])) {
    ...
    if ($iPropertyID != 0) {
        ...
        $rsProperty = propertyEditorDbFetchArray(propertyEditorDbQuery($sSQL));
        extract($rsProperty);
...
$rsPropertyTypes = propertyEditorDbQuery($sSQL);
                    ...
                    <form method="post" action="PropertyEditor.php?PropertyID=<?= InputUtils::escapeAttribute($iPropertyID) ?>&Type=<?= InputUtils::escapeAttribute($sType) ?>">
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="Class">
                                ...
                                <?php
                                while ($aRow = propertyEditorDbFetchArray($rsPropertyTypes)) {
                                    extract($aRow);
