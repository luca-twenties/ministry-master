...
{
    $renderer = new PhpRenderer(__DIR__ . '/../templates/common/');
...
{
    $renderer = new PhpRenderer(__DIR__ . '/../templates/root/');
    ...
    // DISABLED: This causes redirect loop - let admin see empty dashboard instead
