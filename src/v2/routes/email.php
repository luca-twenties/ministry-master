...
{
    $renderer = new PhpRenderer(__DIR__ . '/../templates/email/');
...
{
    return renderPage($response, __DIR__ . '/../templates/email/', 'duplicate.php', _('Duplicate Emails'));
}

function getFamiliesWithoutEmailsMVC(Request $request, Response $response, array $args): Response
{
    return renderPage($response, __DIR__ . '/../templates/email/', 'without.php', _('Families Without Emails'));
}
