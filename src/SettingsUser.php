...
function settingsUserDbQuery(string $sql, bool $bStopOnError = true)
{
...
function settingsUserDbFetchRow(&$result)
{
...
if (isset($_POST['save'])) {
    ...
    while ($current_type = current($type)) {
        ...
        $rsUpdate = settingsUserDbQuery($sSQL);
        next($type);
    }
}
...
$rsConfigs = settingsUserDbQuery($sSQL);
?>
<!-- Default box -->
<div class="card">
        ...
        <form method=post action=SettingsUser.php'>
            ...
            <div class="table-responsive">
                <table class='table table-responsive'>
                    ...
                    while (list($ucfg_per_id, $ucfg_id, $ucfg_name, $ucfg_value, $ucfg_type, $ucfg_tooltip, $ucfg_permission) = settingsUserDbFetchRow($rsConfigs)) {
