...
function sundaySchoolClassViewDbQuery(string $sql)
{
...
function sundaySchoolClassViewDbFetchArray(&$result)
{
...
$rsSundaySchoolClass = sundaySchoolClassViewDbQuery($sSQL);
while ($aRow = sundaySchoolClassViewDbFetchArray($rsSundaySchoolClass)) {
