...
function geoPageDbQuery(string $sql)
{
...
function geoPageDbNumRows($result): int
{
...
function geoPageDbFetchArray(&$result)
{
    if (is_array($result) && array_key_exists('rows', $result)) {
            ...
            <table id="neighbours" class="table table-striped table-bordered data-table dataTable no-footer"
                ...
                <tbody>
                    ...
                    foreach ($resultsByDistance as $oneResult) {
                        ...
                        $rsPeople = geoPageDbQuery($sSQL);
                        $numListed = geoPageDbNumRows($rsPeople);
                        ...
                        <?php
                        while ($aRow = geoPageDbFetchArray($rsPeople)) {
                            extract($aRow);
