...
<div class="login-box">
    ...
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="<?= SystemURLs::getRootPath() ?>" class="h1"><img src="<?= SystemURLs::getRootPath() ?>/Images/ministrymaster-350.jpg" alt="MinistryMaster" style="max-width:330px; height:auto;" /></a>
        </div>
        <div class="card-body">
