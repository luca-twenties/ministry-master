...
function manageEnvelopesDbQuery(string $sql)
{
...
function manageEnvelopesDbFetchArray(&$result)
{
...
$rsClassifications = manageEnvelopesDbQuery($sSQL);
while ($aRow = manageEnvelopesDbFetchArray($rsClassifications)) {
    extract($aRow);
...
function getEnvelopes(?int $classification = null): array
{
    ...
    $dEnvelopes = manageEnvelopesDbQuery($sSQL);
    $envelopes = [];
    while ($aRow = manageEnvelopesDbFetchArray($dEnvelopes)) {
        extract($aRow);
