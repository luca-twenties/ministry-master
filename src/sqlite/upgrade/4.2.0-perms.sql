...
INSERT OR IGNORE INTO `permissions` (`permission_id`, `permission_name`, `permission_desc`) VALUES
...
INSERT OR IGNORE INTO `roles` (`role_id`, `role_name`, `role_desc`) VALUES
...
CREATE UNIQUE INDEX IF NOT EXISTS permission_name ON permissions(permission_name);
...
--
-- SQLite autoincrement handled by INTEGER PRIMARY KEY if needed.
