...
(1, 'SELECT ''<a href=v2/family/'' || fam_ID || ''>'' || fam_Name || ''</a>'' AS ''Family Name'' FROM family_fam Where fam_WorkPhone != ''''', 'Family Member Count', 'Returns each family and the total number of people assigned to them.', 0);
