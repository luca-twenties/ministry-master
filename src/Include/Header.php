  ...
  <!-- Left side column. contains the sidebar -->
    ...
    <!-- Logo -->
      <a href="<?= SystemURLs::getRootPath() ?>/v2/dashboard" class="brand-link">
          ...
          <img src="<?= SystemURLs::getRootPath() ?>/Images/ministrymaster-50.png" alt="MinistryMaster Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
          <!-- logo for regular state and mobile devices -->
                    <span class="brand-text font-weight-light unifrakturmaguntia-regular"><?= ChurchMetaData::getChurchName() ?: 'MinistryMaster' ?></span>
      </a>
