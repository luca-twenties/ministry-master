...
abstract class Config implements ActiveRecordInterface
{
     ...
     */
    protected int|null $cfg_id = null;
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $rowIndex = $useNumericIndex ? $startcol + 0 : ConfigTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->cfg_id = $columnValue !== null ? (int)$columnValue : null;

            $rowIndex = $useNumericIndex ? $startcol + 1 : ConfigTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
            $this->cfg_name = $columnValue !== null ? (string)$columnValue : null;

            $rowIndex = $useNumericIndex ? $startcol + 2 : ConfigTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType);
            $columnValue = $row[$rowIndex];
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(ConfigTableMap::COL_CFG_ID)) {
            $criteria->setUpdateValue($tableMap->getColumn('cfg_id'), $this->cfg_id);
        }
        if ($this->isColumnModified(ConfigTableMap::COL_CFG_NAME)) {
    ...
    public function buildPkeyCriteria(): Criteria
    {
        ...
        $cfg_idColumn = new LocalColumnExpression($query, $tableMap->getName(), $tableMap->getColumn('cfg_id'));
        $query->addAnd($cfg_idColumn, $this->cfg_id);
