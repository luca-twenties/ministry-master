...
class Version extends BaseVersion
{
    public function preSave(ConnectionInterface $con = null): bool
    {
        ...
        $connection = $con ?? Propel::getConnection();
        ...
        if (!ArrayUtils::inArrayRecursive('ver_update_end', $results)) { //the versions table does not contain the ver_update_end column.
