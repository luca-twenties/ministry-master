...
class LocalAuthentication implements IAuthenticationProvider
{
    ...
    public static function fromSession(User $user, ?int $lastOperationTimestamp): self
    {
        $instance = new self();
        $instance->currentUser = $user;
        $instance->bPendingTwoFactorAuth = false;
        $instance->tLastOperationTimestamp = $lastOperationTimestamp ?? time();
    ...
    private function prepareSuccessfulLoginOperations(): void
    {
        ...
        $_SESSION['authUserId'] = $this->currentUser->getId();
        $_SESSION['authLastOp'] = $this->tLastOperationTimestamp;
