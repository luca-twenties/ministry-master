...
class SundaySchoolService
{
    ...
    public function getClassByRole(string $groupId, string $role): array
    {
        ...
        $rsMembers = $this->dbQuery($sql);
        $members = [];
        while ($row = $this->dbFetchAssoc($rsMembers)) {
            $members[] = $row;
        }
    ...
    public function getKidsFullDetails(string $groupId): array
    {
        ...
        $rsKids = $this->dbQuery($sSQL);
        $kids = [];
        while ($row = $this->dbFetchAssoc($rsKids)) {
            $kids[] = $row;
        }
...
SQL;
        $rsKidsMissing = $this->dbQuery($sSQL);
        $kids = [];
        while ($row = $this->dbFetchArray($rsKidsMissing)) {
            $kids[] = $row;
        }
