...
function memberRoleChangeDbQuery(string $sql)
{
...
function memberRoleChangeDbFetchArray(&$result)
{
...
$rsCurrentRole = memberRoleChangeDbFetchArray(memberRoleChangeDbQuery($sSQL));
...
$rsAllRoles = memberRoleChangeDbQuery($sSQL);
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <select name="NewRole" id="NewRole" class="form-control">
                    ...
                    while ($aRow = memberRoleChangeDbFetchArray($rsAllRoles)) {
                        extract($aRow);
