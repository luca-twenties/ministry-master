...
function groupReportsDbQuery(string $sql)
{
...
function groupReportsDbNumRows($result): int
{
...
function groupReportsDbFetchArray(&$result)
{
    if (is_array($result) && array_key_exists('rows', $result)) {
...
$rsGroups = groupReportsDbQuery($sSQL);
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <select id="GroupID" name="GroupID" onChange="UpdateRoles();">
                                ...
                                while ($aRow = groupReportsDbFetchArray($rsGroups)) {
                                    extract($aRow);
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="Reports/GroupReport.php">
                        ...
                        $sSQL = 'SELECT prop_Field, prop_Name FROM groupprop_master WHERE grp_ID = ' . $iGroupID . ' ORDER BY prop_ID';
                                $rsPropFields = groupReportsDbQuery($sSQL); ?>
                        ...
                        <table class="mx-auto">
                            ...
                            <tr>
                                ...
                                <td class="TextColumn">
                                    <?php
                                    if (groupReportsDbNumRows($rsPropFields) > 0) {
                                        while ($aRow = groupReportsDbFetchArray($rsPropFields)) {
                                            extract($aRow);
