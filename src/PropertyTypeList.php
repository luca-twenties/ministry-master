...
function propertyTypeListDbQuery(string $sql)
{
...
function propertyTypeListDbFetchArray(&$result, ?int $mode = null)
{
    if ($mode === null) {
...
$rsPropertyTypes = propertyTypeListDbQuery($sSQL);
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
                <table class="table table-hover table-striped">
                    ...
                    <?php
                    $hasRows = false;
                    while ($aRow = propertyTypeListDbFetchArray($rsPropertyTypes)) {
                        $hasRows = true;
                        $prt_ID = $aRow['prt_ID'];
