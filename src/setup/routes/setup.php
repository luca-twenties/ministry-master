...
$app->group('/', function (RouteCollectorProxy $group): void {
    ...
    $postHandler = function (Request $request, Response $response, array $args): Response {
        ...
        $configFile = getenv('CHURCHCRM_CONFIG_PATH') ?: ($docRoot . '/Include/Config.php');
        ...
        $includeConfigPath = $docRoot . '/Include/Config.php';
        if ($configFile === $includeConfigPath) {
            ...
            StandaloneUtils::writeStandaloneConfig($configFile, [
                'db_server' => $dbServerName,
                'db_port' => $dbServerPort,
                'db_user' => $dbUser,
